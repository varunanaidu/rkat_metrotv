...
(1, 1, 40, '', 9999999, 'Developer Metro TV', '2021-03-19 11:38:02', 9999999, 'Developer Metro TV', '2021-03-21 19:45:44'),
...
(1, 1, 3, 5, 35, 'Notes 1', 9999999, 'Developer Metro TV', '2021-03-19 12:10:13', 9999999, 'Developer Metro TV', '2021-03-21 19:45:44'),
...
--
ALTER TABLE `tab_action_plan`
  MODIFY `action_plan_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `tr_level2`
  MODIFY `level2_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `tr_level3`
--
ALTER TABLE `tr_level3`
  MODIFY `level3_id` int(11) NOT NULL AUTO_INCREMENT;
